...
"""
Optimized Sequence to Sequence Model
Based on the original Seq2Seq model with minimal improvements
"""
...
if __name__ == '__main__':
    ...
    seq2seq = Seq2Seq_v4(encoder=encoder, decoder=decoder, device=device)
    imgs = torch.randn(16, 3, 8, 128, 128)
