...
from Transformer_SL_2 import TransformerSL_2
...
def main():
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='连续手语识别 - Transformer优化版本')
    ...
    parser.add_argument('--model_path', type=str, default='./models/continuous_transformer_2', help='模型保存路径')
    ...
    # 初始化TensorBoard
    writer = SummaryWriter(log_dir=os.path.join('./runs', f'continuous_slr_transformer_2_{datetime.now().strftime("%Y%m%d_%H%M%S")}'))
