...
from experiments.seq2seq_ablation.model_baseline import build_model


def parse_args():
    parser = argparse.ArgumentParser(description="Seq2Seq baseline training (main WER only).")
    add_base_train_args(
        parser=parser,
        default_model_path="./models/ablation_baseline_mainwer",
        exp_name="baseline_mainwer",
    )
